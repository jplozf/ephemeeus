## Latitude
---
This is the latitude of the current location used to compute events.
...
Latitude and longitude are used together as a coordinate pair to specify a location on the surface of the Earth.
