...
// DlgInputLocation()
//******************************************************************************
DlgInputLocation::DlgInputLocation(QString loc, QWidget *parent)
    : QDialog(parent)
{
    ...
    */
    ...
    bool conn = connect(buttonBox, &QDialogButtonBox::accepted, this, &DlgInputLocation::accept);
    Q_ASSERT(conn);
    conn = connect(buttonBox, &QDialogButtonBox::rejected, this, &DlgInputLocation::reject);
    Q_ASSERT(conn);
...
// getStrings()
//******************************************************************************
QStringList DlgInputLocation::getStrings(QWidget *parent, QString loc, bool *ok)
{
    DlgInputLocation *dialog = new DlgInputLocation(loc, parent);
