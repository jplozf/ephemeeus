...
QMap<QString, callback_function> Varboard::aFunc
    = {{"VarDateTime", &Meeus::VarDateTime},
       ...
       {"VarDaylightSavingTimeOffset", &Meeus::VarDaylightSavingTimeOffset},
       ...
       {"VarSunRightAscension", &Meeus::VarSunRightAscension},
       ...
       {"VarDaylightDuration", &Meeus::VarDaylightDuration},
       {"VarDaylightDurationVersusYesterday", &Meeus::VarDaylightDurationVersusYesterday},
       ...
       {"VarMoonLongitudeGeocentric", &Meeus::VarMoonLongitudeGeocentric},
       {"VarMoonLatitudeGeocentric", &Meeus::VarMoonLatitudeGeocentric},
       {"VarMoonDistanceFromEarth", &Meeus::VarMoonDistanceFromEarth},
    ...
    = {{"Time",
       ...
       {"Location",
        {"VarLatitude",
         ...
         "VarTimeZone",
         "VarUTCTimeOffset",
         "VarDaylightSavingTimeOffset",
         "VarStandardTimeOffset",
         "VarDaylightDuration",
         "VarDaylightDurationVersusYesterday"}},
       {"Sun",
        {"VarSunMeanLongitude",
         "VarSunMeanAnomaly",
         "VarSunCenter",
       ...
       {"Moon",
        {"VarMoonMeanLongitude",
         ...
         "VarMoonLongitudeGeocentric",
         "VarMoonLatitudeGeocentric",
         "VarMoonDistanceFromEarth"}},
       {"Earth",
